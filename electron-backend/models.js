...
module.exports = {
  ...
  gestion: {
    table: 'gestion',
    columns: ['id', 'gestion', 'anio', 'tipo', 'activo', 'visible','id_gestion_siaan', 'created_at', 'updated_at']
  },
  apoyo_familiar: {
  ...
  registro_estudiante: {
    ...
    columns: [
      ...
      'monto_primer_pago', 'plan_primer_pago', 'referencia_primer_pago', 'pagos_realizados', 'pago_credito_tecnologico', 'total_semestre', 'registrado', 'comentarios',
