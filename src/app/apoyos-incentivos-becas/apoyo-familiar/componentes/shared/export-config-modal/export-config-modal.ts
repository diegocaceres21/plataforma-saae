  ...
  getDefaultConfig(): ExportConfig {
    return {
      columns: [
        ...
        { key: 'credito_tecnologico', label: 'Crédito Tecnológico', enabled: true, isCalculated: true },
        { key: 'total_semestre', label: 'Total Semestre', enabled: true, isCalculated: true },
        { key: 'total_semestre_descuento', label: 'Total Semestre con Descuento', enabled: true, isCalculated: true },
        { key: 'ahorro_descuento', label: 'Ahorro por Descuento', enabled: true, isCalculated: true },
        { key: 'monto_primer_pago', label: 'Monto Primer Pago', enabled: true, isCalculated: true },
        { key: 'pagos_realizados', label: 'Pagos Realizados', enabled: true, isCalculated: true },
        { key: 'pago_credito_tecnologico', label: 'Pago Crédito Tecnológico', enabled: true, isCalculated: true },
        { key: 'saldo_semestre_original', label: 'Saldo Semestre sin Descuento', enabled: true, isCalculated: true },
